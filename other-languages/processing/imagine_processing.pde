...
final Range RADIUS_DECAY = new Range(0.95, 0.98);
final float MAX_INITIAL_V = 1;
final Range INITIAL_RADIUS = new Range(5, 20);
final Range FORCE_AMPLITUDE = new Range(-0.05, 0.05);
...
void addSparks(int centerX, int centerY) {
